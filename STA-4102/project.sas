...
proc import out = PROJECT_1
			datafile = "\\Client\A$\Documents\SAS\R4102\dat_file\DataFor_PROJECT_1.xlsx" 
     		dbms = xlsx replace;
     		getnames = yes;		
run;
...
proc print data = clinic_1_2_I;
	title '2 Random patients with Stage I cancer from Clinic 1';
run;
...
proc print data = clinic_2_2_I;
	title '2 Random patients with Stage I cancer from Clinic 2';
run;
...
proc print data = clinic_3_2_I;
	title '2 Random patients with Stage I cancer from Clinic 3';
run;
...
proc print data = clinic_4_2_I;
	title '2 Random patients with Stage I cancer from Clinic 4';
run;
...
proc print data = clinic_5_2_I;
	title '2 Random patients with Stage I cancer from Clinic 5';
run;
...
proc print data = clinic_6_2_I;
	title '2 Random patients with Stage I cancer from Clinic 6';
run;
...
proc print data = clinic_7_2_I;
	title '2 Random patients with Stage I cancer from Clinic 7';
run;
