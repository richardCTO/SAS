...
data PROJECT_1 "\\Client\A$\Documents\SAS\PROJECT_1";
	set myxlsx.sheet1;
run;
...
proc print data = clinic2_2;
	title '2 Randomly Secelected Patients with Stage I Cancer from Clinic 2';
run;
...
proc print data = clinic3_2;
	title '2 Randomly Secelected Patients with Stage I Cancer from Clinic 3';
run;
...
proc print data = clinic4_2;
	title '2 Randomly Secelected Patients with Stage I Cancer from Clinic 4';
run;
...
proc print data = clinic5_2;
	title '2 Randomly Secelected Patients with Stage I Cancer from Clinic 5';
run;
...
proc print data = clinic6_2;
	title '2 Randomly Secelected Patients with Stage I Cancer from Clinic 6';
run;
...
proc print data = clinic7_2;
	title '2 Randomly Secelected Patients with Stage I Cancer from Clinic 7';
run;
...
proc print data = clinic1_12;
	title '12 Randomly Secelected Patients with Stage II Cancer from Clinic 1';
run;
...
proc print data = clinic2_12;
	title '12 Randomly Secelected Patients with Stage II Cancer from Clinic 2';
run;
...
proc print data = clinic3_12;
	title '12 Randomly Secelected Patients with Stage II Cancer from Clinic 3';
run;
...
proc print data = clinic4_12;
	title '12 Randomly Secelected Patients with Stage II Cancer from Clinic 4';
run;
...
proc print data = clinic5_12;
	title '12 Randomly Secelected Patients with Stage II Cancer from Clinic 5';
run;
...
proc print data = clinic6_12;
	title '12 Randomly Secelected Patients with Stage II Cancer from Clinic 6';
run;
...
proc print data = clinic7_12;
	title '12 Randomly Secelected Patients with Stage II Cancer from Clinic 7';
run;
...
proc print data = clinic1_25;
	title '25 Randomly Secelected Patients with Stage II Cancer from Clinic 1';
run;
...
proc print data = clinic2_25;
	title '25 Randomly Secelected Patients with Stage III Cancer from Clinic 2';
run;
...
proc print data = clinic3_25;
	title '25 Randomly Secelected Patients with Stage III Cancer from Clinic 3';
run;
...
proc print data = clinic4_25;
	title '25 Randomly Secelected Patients with Stage III Cancer from Clinic 4';
run;
...
proc print data = clinic5_25;
	title '25 Randomly Secelected Patients with Stage III Cancer from Clinic 5';
run;
...
proc print data = clinic6_25;
	title '25 Randomly Secelected Patients with Stage III Cancer from Clinic 6';
run;
...
proc print data = clinic7_25;
	title '25 Randomly Secelected Patients with Stage III Cancer from Clinic 7';
run;
